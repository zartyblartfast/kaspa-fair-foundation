...
require('future/live round transaction evidence safe or replaced by authorised later ENV', proof.get('future_live_round_transaction_evidence') in ('not_created_not_claimed_future_work', 'replaced_by_env088_covenant_linked_lineage_evidence'))
